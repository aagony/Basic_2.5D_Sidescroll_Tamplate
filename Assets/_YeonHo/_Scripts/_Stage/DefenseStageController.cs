...
public class DefenseStageController : MonoBehaviour
{
    ...
    private void RegisterEnemy(GameObject enemy)
    {
        ...
        MonsterStatus monsterStatus = enemy.GetComponentInChildren<MonsterStatus>();

        if (monsterStatus == null)
        {
            Debug.LogWarning("Spawned enemy has no MonsterStatus. It may not clear correctly.", enemy);
        }
    }
    ...
    private bool IsEnemyDead(GameObject enemy)
    {
        ...
        return monsterStatus.Status != null && monsterStatus.Status.IsDead;
    }
